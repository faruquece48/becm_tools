...
export default function StudentDirectory() {
  ...
  async function saveStudent(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (!response.ok) { setFormError(body.error || "Unable to save student"); return; }
  ...
  return <section className="min-h-screen bg-[#f7f9fd] p-3 sm:p-6">
    <div className="border-t border-[#0a315b] bg-white shadow-sm">
      <div className="grid items-center gap-4 border-b border-slate-200 px-5 py-4 md:grid-cols-3">
        ...
        <button type="button" onClick={() => { setFormError(""); setEditing({ ...emptyStudent }); }} className="justify-self-center rounded bg-[#082f57] px-4 py-2 text-sm font-bold text-white md:col-start-2"><Plus className="mr-1 inline h-4 w-4" />Add Student</button>
