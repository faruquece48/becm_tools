...
import { statusInsteadOfFailedSubjects } from "@/lib/resultFormatPolicy";
...
export default function NonObeExamTable({ selection, legacyFormat }: { selection: Selection; title: string; legacyFormat: boolean }) {
  ...
  return <div className="mt-10 pt-2">
    ...
    <SyncedHorizontalScroll><table className="non-obe-marks-table w-max border-collapse text-sm">
