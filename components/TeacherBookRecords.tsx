...
export default function TeacherBookRecords() {
  ...
  return <section className="teacher-book-records space-y-6">
    ...
    <style jsx global>{`
      .teacher-book-records table th,
      .teacher-book-records table td { text-align: center; }
      .teacher-book-records table tbody td:last-child > div { justify-content: center; }
    `}</style>
  </section>;
}
