...
test("regular sheets use the batch corresponding to the selected exam", () => {
  assert.equal(belongsToRegularExam({ ...student, series: "2021", year: "2nd", semester: "Odd", placementExamYear: "2023" }, directory, ["A"], [], exam), true);
  assert.equal(belongsToRegularExam({ ...student, series: "2021", year: "2nd", semester: "Odd" }, directory, ["A"], [], exam), false);
  assert.equal(belongsToRegularExam({ ...student, series: "2021", year: "2nd", semester: "Even" }, directory, ["A"], [], exam), false);
